...
class FilteredBackendTestCase(TransactionTestCase):
    ...
    def test_can_declare_filters_which_apply_to_get_user(self):
        staff = create_user(username='staff', is_staff=True, is_superuser=False)
        superuser = create_user(username='superuser', is_staff=True, is_superuser=True)
        customer = create_user(username='customer', is_staff=False, is_superuser=False)
...
class ActAsModelBackendTestCase(TransactionTestCase):
    ...
    def test_can_become_another_user_with_own_password(self):
        admin = create_user(username='admin', password='admin password')
    ...
    def test_cannot_become_nonexistent_user(self):
        admin = create_user(username='admin', password='password')
    ...
    def test_regression_test_for_only_super_user_can_act_as_model_backend(self):
        ...
        admin1 = create_user(username='admin1', password='admin1 password', is_superuser=True)
    ...
    def test_can_customize_can_act_as_policy_by_subclassing(self):
        ...
        bob = create_user(username='bob', password='bob')
